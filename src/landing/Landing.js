        ...
        <center>
          ...
          <div className={styles.about}>
            ...
            <p>
              ...
              caffeine to energize hungry and excited hackers. Your sleepless
              efforts will be rewarded with swag and other goodies!
            </p>
            <p>
              Hacking begins at 2 PM on Saturday, April 20th right after the
              opening ceremony and ends at 2 PM on Sunday, April 21st. You must
              submit your project on Devpost. In order to be eligible for
              prizes, you also must demonstrate your project.
            </p>
          </div>
          ...
          <div className={styles.faq}>
            ...
            <div>
              <h2 className={styles.lobsterFont}>
