    ...
    <main className={classes.root}>
      ...
      <Container>
        ...
        <ExpansionPanel className={classes.faq}>
          ...
          <ExpansionPanelDetails>
            <Typography>
              ...
              own hardware which can be found on the DragonHacks Hardware List.
            </Typography>
          </ExpansionPanelDetails>
        </ExpansionPanel>
        <ExpansionPanel className={classes.faq}>
          ...
          <ExpansionPanelDetails>
            <Typography>
              ...
              will have the opportunity to compete in plenty of challenges for a
              chance to win: Xbox Ones, PS4s, GoPros, Apple Watches, Samsung LED
              TVs, Nintendo Switches, iPad Airs, and way more! First place gets
              first choice of prizes with each member in the winning team
        ...
        <ExpansionPanel className={classes.faq}>
          ...
          <ExpansionPanelDetails>
            <Typography>
              ...
              #teamformation channel dedicated to team formations. We will also
              be holding a team formation event before the kickoff and opening
        ...
        <ExpansionPanel className={classes.faq}>
          ...
          <ExpansionPanelDetails>
            <Typography>
              ...
              Martin, Close School of Entrepreneurship, GLOBO, and more! The
              full list of challenges are listed in the Official DragonHacks{' '}
              {YEAR} Devpost.
            </Typography>
          </ExpansionPanelDetails>
        </ExpansionPanel>
        ...
        <ExpansionPanel className={classes.faq}>
          ...
          <ExpansionPanelDetails>
            <Typography>
              The event starts at {START_TIME} on {START_DATE}. It will be held
              in the{' '}
