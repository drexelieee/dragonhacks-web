    ...
    <main className={classes.root}>
      ...
      <Container>
        ...
        <Typography>
          ...
          event hosted by Drexel University IEEE in {START_DATE.getFullYear()}{' '}
          in the Bossone Research Enterprise Center. DragonHacks{' '}
          {START_DATE.getFullYear()} is bringing the brightest minds of the
          world's best schools to spend 24 hours to hours to create ground
      ...
      <Container>
        ...
        <div>
          ...
          <Typography>
            ...
            DragonHacks {START_DATE.getFullYear()}: MLH Hardware. We will also
            be providing our own hardware which can be found on the DragonHacks
            Hardware List.
          </Typography>
        </div>
        <div>
          ...
          <Typography>
            There are plenty of prizes to be won at DragonHacks{' '}
            {START_DATE.getFullYear()}! You will have the opportunity to compete
            in plenty of challenges for a chance to win: Xbox Ones, PS4s,
            GoPros, Apple Watches, Samsung LED TVs, Nintendo Switches, iPad
            Airs, and way more! First place gets first choice of prizes with
            each member in the winning team choosing one prize from the list,
            down to the last DragonHacks challenge winners. All projects must be
        ...
        <div>
          ...
          <Typography>
            ...
            {START_DATE.getFullYear()} Devpost site. We highly recommend you
            submit at 1:30 PM to give yourself some wiggle room for any
            last-minute technical issues. All projects must be submitted on
            Devpost in order to be eligible for judging and prizes!
          </Typography>
        </div>
        <div>
          <Typography variant='h3'>
          ...
          <Typography>
            ...
            official DragonHacks {START_DATE.getFullYear()} Slack Group where we
            have a #teamformation channel dedicated to team formations. We will
            also be holding a team formation event before the kickoff and
            opening ceremony. Also check out the DragonHacks{' '}
            {START_DATE.getFullYear()} Devpost challenges for inspiration on
        ...
        <div>
          ...
          <Typography>
            ...
            list of challenges are listed in the Official DragonHacks{' '}
